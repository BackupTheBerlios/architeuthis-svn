/*
 * file:        CachingTestPartialSolution.java
 * created:     <???>
 ...
 */
public class CachingTestPartialSolution implements PartialSolution {
     ...
     */
    CachingTestPartialSolution(ArrayList list) {
        solution = list;
    }

    /**
     * Liefert eine Liste von PrimeNumbers, die noch von
     * <code>CachingTestProblem</code> weiterverarbeitet werden muss.
     * Der Zugriff ist package-local, da die Methode nur von
     * <code>CachingTestProblem</code> verwendet werden muss.
     *
