...
Man betrachte zunächst die folgende Methode {\tt primzahlTeilbereich} aus
...
daß jedem Teilproblem ein Teilintervall gleicher Größe zugeordnet wird. In
\texttt{createSolution} werden dann alle Teillösungen in ihrer Reihenfolge
im Array aneinandergehängt (zum konkreten Typ der Elemente des Array s.u.).
Das Gesamtintervall wird durch die Unter- und Obergrenze dem Konstruktor
des Problems übergeben. Nachfolgend die vollständige Implementierung der
Problem-Klasse.
...
Konstruktor das zu durchsuchende Teilintervall übergeben wird und
...
Unter Windows müssen in den Pfadangaben die Slashes durch Backslashes
