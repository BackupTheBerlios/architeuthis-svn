...
\item  Aufeinanderfolgende Lesezugriffe zweier Teilprobleme ohne
       ...
       Dieses Verfahren kann dadruch realisiert werden, daß ein zentraler
       Speicher und zusätzlich auf jedem Operative ein dezentraler Speicher
       vorhanden. Das Schreiben aller Teilprobleme erfolgt
       unterbrechungsfrei in den zentralen Speicher (d.h.\ ohne daß während
       des Schreibens ein anderes Teilproblem in den zentralen Speicher
       schreibt) und ist erst abgeschlossen, wenn das Schreiben auch auf
       allen dezentralen Speichern erfolgt ist. Das Lesen erfolgt aus dem
...
\item  Aufeinanderfolgende Lesezugriffe zweier Teilprobleme ohne
       ...
       Lesezugriffe wie Schreibzugriffe der Teilprobleme (ersteinmal) nur
       auf den dezentralen Speicher erfolgen. Schreibzugriffe würden dann
       anschließend (d.h.\ nebenläufig zur weiteren Berechnung des
       Teilproblems und zu weiteren Schreibzugriffen ander Teilprobleme auf
       ihren jeweiligen dezentralen Speicher) an den zentralen Speicher
       weitergeleitet, der sie wiederum an die anderen dezentralen Speicher
       weiterleitet.
\end{enumerate}

Wenn aufeinanderfolgende Lesezugriffe zweier Teilprobleme auf den
gemeinsamen Speicher den geleichen Wert liefern, ist dies in der Regel für
