...
\item  Für die Berechnung eines nicht-serialisierbaren Problems kann die
       zu erzeugende Instanz nur durch den Konstruktor festgelegt werden
       und als Parameter können nur Objekte angegeben werden (keine Werte
       elementaren Typs).

\item  Für die Berechnung eines nicht-serialisierbaren Problems muß außerdem
       der Klassenname als String angegeben werden, wodurch der Compiler
       keine entsprechenden Prüfungen mehr vornehmen kann.
\end{itemize}

Zur Übertragung eines Problems mittels \texttt{ProblemTransmitterImpl} muß
von dieser Klasse unter Angabe des Rechnernames des Compute-Managers eine
...
eine Instanz auf dem Compute-Manager erzeugt wird, ist ein Array mit
