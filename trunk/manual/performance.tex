...
für die aktuelle Version nur noch begrenzt aussagekräftig.
...
Durchführung der Tests auch von anderen Leuten benutzt wurde. Alle genannten
...
Für das Prim-Problem ist die Aufgabenstellung: Berechne die 2.000.000te
...
Hier ist die Aufgabe ebenfalls: Berechne die 2.000.000te Primzahl. Außerdem
werden jedoch drei Klassen zusätzlich vom Webserver geladen, um zu testen,
...
Dieser Test soll Aufschluss über die effektive Geschwindigkeitssteigerung
...
das Laden der Klassen überproportional viel Zeit benötigt.

\subsubsection{Test mit Caching von Teillösungs-Klasse}

Ein weiterer Test zum Caching bestand darin, 3 Probleme, die ebenfalls die 
2.000.000te Primzahl berechnen, zu vergleichen. Zusätzlich zum Prim- und zum
...
1  & 0,90  & 0,90 \\
\end{tabular}
\caption{Speedup bezüglich Caching von Teilproblemen}
...
1  & 0,88  & 0,88  \\
\end{tabular}
\caption{Speedup bezüglich Caching von Teillösungen}
