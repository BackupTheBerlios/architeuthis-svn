...
Dies geschieht wie im vorherigen Kapitel mit dort beschriebenen Klasse
\texttt{PrimePartialProblemImpl}.
...
kapseln und außerdem die Identifikationsnummer beinhalten. Dafür wird
im im vorhergehenden Kapitel die Klasse \texttt{ContainerPartialSolution}
verwendet.
