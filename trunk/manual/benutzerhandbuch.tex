...
\usepackage[pdftex=true,
            ...
            pdfauthor={Jürgen Heit, Andreas Heydlauff, Ralf Kible,
                       Achim Linke, Michael Wohlfart, Dietmar Lippold},
...
Das System \emph{Architeuthis} soll einem Benutzer die M"oglichkeit geben,
ein von ihm in Java implementiertes Problem auf einfache Weise auf mehreren
Rechnern verteilt berechnen zu lassen. Es besteht aus mehreren Komponenten,
deren Funktion und Benutzung in diesem Handbuch erläutert wird.

Da die Packages des Systems recht tief geschachtelt sind, werden deren Namen
bei der Angabe von Klassen teilweise gekürzt. Anstatt\\
...
wurde, wird teilweise auf die Angabe vom Package komplett verzichtet. 
    ...
    \include{ueberblick}
    \include{funktionalitaet}
    \include{benutzung}
    \include{gemeinsamerSpeicher}
    \include{sicherheit}
    \include{hilfsklassen}
